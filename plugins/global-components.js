...
import AqIllustration from "~/components/core/AqIllustration.vue";
import AqSheet from "~/components/core/AqSheet.vue";
import AqSelect from "~/components/core/AqSelect.vue";
import AqSegment from "~/components/core/AqSegment.vue";
...
export default defineNuxtPlugin((nuxtApp) => {
  ...
  nuxtApp.vueApp.component("AqIllustration", AqIllustration);
  nuxtApp.vueApp.component("AqSheet", AqSheet);
  nuxtApp.vueApp.component("AqSelect", AqSelect);
  nuxtApp.vueApp.component("AqSegment", AqSegment);
